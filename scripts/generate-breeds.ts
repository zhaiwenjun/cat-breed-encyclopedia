...
const breeds: BreedData[] = [
  // ============ A ============
  {
    ...
    featuredImage: "/images/breeds/abyssinian.webp", featuredImageAlt: "Ruddy Abyssinian cat with ticked coat sitting alertly",
...
5. Their kitten coat is darker and less ticked than their adult coat, which develops fully by 18 months.`
  },
  {
    ...
    featuredImage: "/images/breeds/aegean.webp", featuredImageAlt: "Aegean cat with semi-longhair coat",
...
**Cons:** Rare and difficult to find outside Greece, moderate grooming requirements, may be too independent for some owners.`
  },
  {
    ...
    featuredImage: "/images/breeds/american-bobtail.webp", featuredImageAlt: "American Bobtail cat with distinctive short tail",
...
**Cons:** Can be difficult to find from breeders, moderately expensive, may be too active for very sedentary households.`
  },
  {
    ...
    featuredImage: "/images/breeds/american-curl.webp", featuredImageAlt: "American Curl cat with distinctive curled ears",
